#########################################################################
#This script can be used to estimate NGAM in 6h18h growth condition 	#
...
rxn = cobra_model.reactions.get_by_id("diel_biomass")
rxn.add_metabolites({cobra_model.metabolites.get_by_id("X_Phloem_contribution_t1"):((-3.0*6)/12) - (-3),cobra_model.metabolites.get_by_id("X_Phloem_contribution_t2"):((-1.0*18)/12 - (-1))})
