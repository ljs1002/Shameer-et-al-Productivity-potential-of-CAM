...
#rate ratio is 1:1 based on the assumption that carbon conversion 	#
...
#Set day-night phloem export rate ratio to 1:1
rxn = cobra_model.reactions.get_by_id("diel_biomass")
rxn.add_metabolites({cobra_model.metabolites.get_by_id("X_Phloem_contribution_t1"):2})
