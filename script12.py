...
# in the phloem is 0.99 based on the assumption that carbon conversion 	#
...
#constrain sugar:aa to 0.70
for i in range(1,3):
  cobra_model.reactions.get_by_id("Phloem_output_tx"+str(i)).add_metabolites({cobra_model.metabolites.get_by_id("sSUCROSE_b"+str(i)):-6,cobra_model.metabolites.get_by_id("GLC_c"+str(i)):-0.57,cobra_model.metabolites.get_by_id("FRU_c"+str(i)):-0.65,cobra_model.metabolites.get_by_id("PROTON_e"+str(i)):-1.32,cobra_model.metabolites.get_by_id("PROTON_c"+str(i)):1.32})
