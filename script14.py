#########################################################################
#This script can be used to estimate NGAM when day-night phloem export	#
#rate ratio is 3:2 based on the assumption that carbon conversion 	#
...
#Set day-night phloem export rate ratio to 3:2
rxn = cobra_model.reactions.get_by_id("diel_biomass")
rxn.add_metabolites({cobra_model.metabolites.get_by_id("X_Phloem_contribution_t2"):(-1)})
